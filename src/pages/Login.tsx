          ...
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            <div style={{ position: "relative", display: "inline-block", marginBottom: 16 }}>
              <div style={{
                ...
                <img src="/lion.jpg" alt="SaitoGlory" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
            </div>
            <h2 className="heading" style={{ fontSize: 28, fontWeight: 800, color: "#fff", marginBottom: 6 }}>Welcome Back</h2>
            <p style={{ fontSize: 13, color: "var(--text-muted)" }}>Sign in to <span style={{ color: "var(--gold3)", fontWeight: 600 }}>SaitoGlory</span> panel</p>
          </div>
