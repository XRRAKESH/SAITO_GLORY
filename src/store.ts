...
const OWNER_USERNAME = 'saito_ea';
const OWNER_PASSWORD = 'saito_lord';

const DEFAULT_SETTINGS: Settings = {
  upiId: '8100487734@fam',
  qrImageBase64: '',
  announcementText: 'Welcome to SaitoGlory! Top up your credits to get started.',
};
